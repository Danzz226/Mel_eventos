...
<head>
    ...
    <title>Planejamento de Eventos - EventHub</title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="form-section" style="text-align: center;">
                <h1 class="page-title">📅 Planejamento de Eventos</h1>
                <p style="font-size: 1.2rem; color: var(--secondary-color); margin: 2rem 0;">
                    Gerencie datas, horários e detalhes do seu evento de forma simples e organizada.
                </p>
