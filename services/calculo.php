...
<head>
    ...
    <title>Cálculo de Custos - EventHub</title>
    ...
    <main class="main-content">
        <div class="container">
            <div class="form-section" style="text-align: center;">
                <h1 class="page-title">💰 Cálculo de Custos</h1>
                <p style="font-size: 1.2rem; color: var(--secondary-color); margin: 2rem 0;">
                    Sistema automático de cálculo de valores com base em serviços e participantes.
                </p>
