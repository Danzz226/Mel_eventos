...
$resultado = $reservaManager->criarReserva($dados);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
        ...
        <div class="container">
            <div class="form-section" style="text-align: center; padding: 3rem;">
                <?php if ($resultado['sucesso']): ?>
                    ...
                    <h2 style="color: #28a745; margin-bottom: 1rem;">Reserva Criada com Sucesso!</h2>
                    <p style="font-size: 1.1rem; margin-bottom: 2rem;"><?= htmlspecialchars($resultado['mensagem']) ?></p>
                <?php else: ?>
                    <div style="font-size: 4rem; margin-bottom: 1rem;">❌</div>
                    <h2 style="color: #dc3545; margin-bottom: 1rem;">Erro ao Criar Reserva</h2>
                    <p style="font-size: 1.1rem; margin-bottom: 2rem;"><?= htmlspecialchars($resultado['mensagem']) ?></p>
                <?php endif; ?>
